...
public class CompareImages {
    ...
    private void loadImages() {
        // Load images
        try {
            images.put("Image1", ImageIO.read(new File("src/main/resources/image1.jpg")));
            images.put("Image2", ImageIO.read(new File("src/main/resources/images2.jpg")));
